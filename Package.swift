...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "NeuronKit",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/neuronkit-vb5db5fb-swift6_0/NeuronKit.xcframework.zip",
      checksum: "628acc088a8ff1baf56ec0015fe3ca742477b3194c2b5c1ce7b3243228b2602f"
    )
  ]
)
