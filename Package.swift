...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "ConvoUI",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/convoui-va296f8c-swift6_0/ConvoUI.xcframework.zip",
      checksum: "67d0e8b6c73132c50b7cdad73aee56df25b9820c2f1cfd918242db8372858cff"
    )
  ]
)
