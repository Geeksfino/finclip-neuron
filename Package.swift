...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "NeuronKit",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/neuronkit-v91f78fe-swift6_0/NeuronKit.xcframework.zip",
      checksum: "3282e7cd4bb7b3b97e00140d3e377d46c7a72628bc2b08bb0631e7211e4d2d20"
    ),
    .binaryTarget(
      name: "ConvoUI",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/convoui-vf80e8d3-swift6_0/ConvoUI.xcframework.zip",
      checksum: "a0e5ef80f9ff5c756c80a901dc68726a06272999e1c68276cb989358f95c5b81"
    )
  ]
)
