...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "NeuronKit",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/neuronkit-v184437e-swift6_0/NeuronKit.xcframework.zip",
      checksum: "4baa7758adfe9356ed96c19c5f791327703ee1ac11940695f5aa15fd73d5cbe4"
    )
  ]
)
