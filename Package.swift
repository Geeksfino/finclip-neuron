...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "NeuronKit",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/neuronkit-v2c27f75-swift6_0/NeuronKit.xcframework.zip",
      checksum: "8ed01f9a60b1ea6228a04117bb08056750b9fdca2e562d2a06dd6ae3a88eb470"
    )
  ]
)
