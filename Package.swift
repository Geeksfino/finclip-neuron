...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "NeuronKit",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/neuronkit-vfbc55e4-swift6_0/NeuronKit.xcframework.zip",
      checksum: "2de40d7d332ac173ee7860684e1fe8643ab8d2954602ac4fe11af3b549f9ce78"
    )
  ]
)
