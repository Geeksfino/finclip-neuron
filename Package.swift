...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "ConvoUI",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/convoui-v0acad75-swift6_0/ConvoUI.xcframework.zip",
      checksum: "ade6dd576fca508696b459707b1feee167e7e7f397ed9bfcb70bca03eb1288c2"
    )
  ]
)
