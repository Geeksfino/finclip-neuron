...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "NeuronKit",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/neuronkit-v6e2eb35-swift6_0/NeuronKit.xcframework.zip",
      checksum: "cf7ee29fe504c0d163b9ffac8e61f3e73742d7020ae1d1667c2ade1d8f62ef9d"
    )
  ]
)
