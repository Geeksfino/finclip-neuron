...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "NeuronKit",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/neuronkit-vab63761-swift6_0/NeuronKit.xcframework.zip",
      checksum: "20670c28a65d6a62c5ff9bb958d4857f9cfa8cc6ec703c05f89500030764493f"
    )
  ]
)
