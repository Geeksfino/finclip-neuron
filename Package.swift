...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "NeuronKit",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/neuronkit-v7602426-swift6_0/NeuronKit.xcframework.zip",
      checksum: "c8c5a26d983f04dfb9628db697aef3ee1ef491dee3ef0667e2aacd9b862f8860"
    )
  ]
)
