...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "NeuronKit",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/neuronkit-v6178992-swift6_0/NeuronKit.xcframework.zip",
      checksum: "361d1d8a1ac0eb89217064fde6a27544fc12fe52e175c430662a4baa9dd7c179"
    )
  ]
)
