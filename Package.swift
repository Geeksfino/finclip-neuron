...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "ConvoUI",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/convoui-v08ef68a-swift6_0/ConvoUI.xcframework.zip",
      checksum: "377ea888dadf88d8accb98404129ec0e6e6f4ed6274f2c2efb1a05f38592df63"
    )
  ]
)
