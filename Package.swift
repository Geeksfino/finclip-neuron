...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "ConvoUI",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/convoui-v10fc8fe-swift6_0/ConvoUI.xcframework.zip",
      checksum: "b3773ef8d99e167016fdeb87b40f46c74061813b3776e531204a558aeffedd51"
    )
  ]
)
