...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "ConvoUI",
      url: "https://github.com/Geeksfino/finclip-neuron/releases/download/convoui-vae2a809-swift6_0/ConvoUI.xcframework.zip",
      checksum: "0789898ea5091345e7c896510d8a73f5b194a7d8ae1dd6cee351f206de8d7e12"
    )
  ]
)
